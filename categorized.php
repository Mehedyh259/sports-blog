    ...
    <div class="container">
        <div class="row">
            <div class=" col-lg-8 col-md-8 col-sm-10 md-mx-auto">
                <h1 class="py-2">Category: <?php echo $id; ?></h1>
            <?php
                
                $query = mysqli_query($conn,"select * from posts where category = '$id' order by id desc");
                ...
                <!-- Blog Post -->
                <div class="card mb-4">
                    <img class="card-img-top p-4" src="img/<?php if(!empty($row['image']))echo $row['image'];else echo'no_image.jpg' ?>" alt="Card image cap">
                    <div class="card-body">
                ...
                <?php } }
                    ...
                    echo "<h1>Couldn't Find any post on this category</h1>";
                }
